<div class="container-fluid py-4">
    ...
    %1$s
        ...
        <div class="col-md-6 mx-auto">
            <form
                method="post"
                action="https://dd5.jhugues.fr/wp-admin/admin.php?page=hj-dd5/admin_manage.php&onglet=character">
                <div class="card bg-light shadow-sm p-0 mw-100">
                    ...
                    <div class="card-body">
                        ...
                        <textarea
                                ...
                                name="characterNotes"
                                rows="4"
                                placeholder="Informations supplémentaires, historique, intentions...">%4$s</textarea>
                        </div>
