  <link rel='stylesheet' href='%4$sassets/styles/adminReset.css?v=%6$s' type="text/css" media='all' />
  <link rel='stylesheet' href='%4$sassets/styles/adminDashboard.css?v=%6$s' type="text/css" media='all' />

  <link rel='stylesheet' href='%4$sassets/styles/dd5.css?v=%6$s' type="text/css" media='all' />
  <link rel='stylesheet' href='%4$sassets/styles/adminBase.css?v=%6$s' type="text/css" media='all' />
...
%5$s
  ...
  <aside style="" class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/wp-admin/admin.php?page=hj-dd5/admin_manage.php" class="brand-link">
      <img src="%4$sassets/images/dd5logo.png" alt="DD5 Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <script src="%4$sassets/js/PushMenu.js"></script>
