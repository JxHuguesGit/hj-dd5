    <div class="combatant-card" data-id="%1$s" draggable="true">
        <div class="combatant-card__row">
            ...
            <button class="btn btn--reroll" data-action="reroll-initiative" title="Relancer l'initiative" aria-label="Relancer l'initiative"><i class="fa-solid fa-refresh"></i></button>
            ...
            <div class="combatant-card__right">
                ...
                <button class="btn btn--remove d-none" title="Tag" aria-label="Tag"><i class="fa-solid fa-tag"></i></button>
                <button class="btn btn--remove d-none" title="Détail" aria-label="Détail"><i class="fa-solid fa-eye"></i></button>
                <div class="d-none">
