                                <h2 style="border: 0px; clip: rect(0px, 0px, 0px, 0px); height: 1px; margin: -1px; overflow: hidden; padding: 0px; position: absolute; white-space: nowrap; width: 1px;">Speed</h2>
                                ...
                                <div class="ct-speed-box__heading ">Marche</div>
                                <div class="ct-speed-box__box-value ">
                                    <span class="styles_numberDisplay__Rg1za styles_largeDistance__YVw96 styles_large__3C8uq"><span>%3$s</span><span class="styles_label__L8mZK styles_largeLabel__E3v8Y styles_labelSignColor__Klmbs">m</span></span>
                                </div>
                                <div class="ct-speed-box__label ">Vitesse</div>
