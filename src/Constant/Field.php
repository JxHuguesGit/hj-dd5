...
class Field
{
    ...
    */
    ...
    public const SOURCECODE    = 'sourceCode';
    public const SOURCENAME    = 'sourceName';
    public const TYPDMGNAME    = 'typeDamageName';
    public const TYPMSTNAME    = 'typeMonsterName';
    public const SCHOOLNAME    = 'schoolName';
    ...
    public const CASTINGTIMEID = 'castingTimeId';
    ...
    public const DURATIONID   = 'durationId';
    ...
    public const RANGEID      = 'rangeId';
    public const REFID        = 'referenceId';
    public const RITUEL       = 'rituel';
    public const SCHOOLID     = 'schoolId';
    public const SKILLID      = 'skillId';
    public const SOURCEID     = 'sourceId';
    public const SPECIESID    = 'speciesId';
    public const SPELLENHANCEMENTID = 'spellEnhancementId';
    public const SPELLID      = 'spellId';
    public const SPELLTRIGGERID = 'spellTriggerId';
